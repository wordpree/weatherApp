...
import cloudy from "./nathan-anderson-clouds-unsplash.jpg";
import sunny from "./adeolu-eletu-sunny-unsplash.jpg";

export { frog, night, thunder, rainy, snow, cloudy, sunny };
